...
flatmate1_days_in_house = int(input("Enter the number of days {} spent int the house: ".format(flatmate1_name)))
flatmate2_name = input("Enter the second of the first_flatmate: ")
flatmate2_days_in_house = int(input("Enter the number of days {} spent int the house: ".format(flatmate2_name)))
